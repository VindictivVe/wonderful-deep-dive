  ...
  const [data, setData] = useState([
    {
      ...
      text1:
        "Die epipelagiale Schicht (gr. pélagos (offene See) und epí (auf)) reicht von der Wasseroberfläche bis in eine Tiefe von 200m. Es gibt viel Licht und Wärme in dieser Schicht, obwohl beide mit zunehmender Tiefe abnehmen. Der Druck ist ebenfalls minimal und steigt mit der Tiefe.",
      text2:
      ...
      text5:
        "Die tiefsten Meeresregionen bezeichnet man als Hadopelagial (gr. ades = Unterwelt). Diese Zone reicht hinab bis in die Tiefseegräben, bis in etwa 11 000 Meter Tiefe. Natürliches Licht kann nicht in die Gräben eindringen. Der Grund der Ozeane ist in der Regel mit einer Schicht organischen Drecks gefüllt, der ein paar Zentimeter tief ist, wie ein Waldboden.",
    },
    {
      id: shortid.generate(),
      title: "Lebewesen",
    ...
    },
    {
      ...
      title: "Klimawandel",
      text1:
        "Die extrem artenreichen Öko-Systeme sind auch durch die wärmeren Temperaturen bedroht. Wissenschaftler gehen davon aus, dass nur rund die Hälfte aller Korallenriffe erhalten bleibt, wenn wir den Temperaturanstieg auf derzeit unrealistische 1,2 Grad Celsius beschränken.  ",
      text2:
    ...
    },
    {
      ...
      text3:
        "Zusätzlich zu der oben genannten Eutrophierung werden bei Fäulnisprozessen die verbliebenen Sauerstoffreste verbraucht, sodass eine Faulschlammschicht entsteht. Als Stoffwechselprodukte entstehen toxische Kohlenwasserstoffe, z.B. Methan. Dadurch sterben Fische, Krebse und Schnecken an Sauerstoffmangel.",
      text4:
        "Das Endstadium der Eutrophierung ist der Extremfall: Das so genannte „Umkippen“ des Sees, in dem der See biologisch tot ist. Meist tritt dieser Fall jedoch nicht ein, sondern es stellt sich ein biologisches Gleichgewicht ein. Den Grad der Eutrophierung kann man u.a. an der Häufigkeit bestimmter Fischarten erkennen.",
      text5:
    ...
    setData([
      ...
      },
      {
        ...
        text3:
          "In dieser Zone leben viele Tiefseearten – Fische, Krebse oder auch Schnecken. Riesen- und Kolossalkalmare sind hier ebenso zu finden wie Pottwale. Die Tiere, die dort leben, haben ausgeprägte Sinne und raffinierte Strategien, um Beute zu machen. Oft haben Sie ein bizarres Aussehen. Zu ihnen zählen Angler-, Viper-, und Fangzahnfische. ",
        text4:
          "Hier leben Grundnahrungsmittel, von denen viele schaufelförmige Kiefer haben, um Ablagerungen vom Meeresboden zu heben. Wirbellose wie Seesterne und Tintenfische können in dieser Umgebung überleben.",
        text5:
          "Forscher gehen davon aus, dass es in dieser Zone massenhaft unentdeckte Arten gibt. Bekannt ist dagegen schon der Borstenwurm, der es dort mit dem ungeheuren Druck und Temperaturen nahe dem Gefrierpunkt aufnimmt. Verschiedene Kreaturen können in dieser Schicht gefunden werden, hauptsächlich Wirbellose einschließlich Seesternen.",
      },
      {
