...
const DepthNavigator = () => {
  ...
  const [data, setData] = useState([
    ...
    },
    {
      ...
      text4: "Hier leben Tierarten, von denen viele schaufelförmige Kiefer haben, um Ablagerungen vom Meeresboden zu heben. Wirbellose wie Seesterne und Tintenfische können in dieser Umgebung überleben.",
